...
.. toctree::
   ...
   backend/mainsetting_funcs
   backend/plc_managment
   backend/pxvalue_calibration
   backend/storage_funcs
   backend/texts
   backend/user_login_logout_funcs
   backend/user_management_funcs